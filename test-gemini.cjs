require('dotenv').config({ path: '/Applications/XAMPP/xamppfiles/htdocs/DATN-Ecommerce-Website/medusa-backend/apps/backend/.env' });
...
checkTextSafety("ôi trời ơiiiii Làm ăn như cứt, tụi mày là lũ lừa đảo.").then(console.log).catch(console.error);
